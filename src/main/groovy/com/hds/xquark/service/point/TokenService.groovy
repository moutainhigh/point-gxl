 ...
 * 轻量级调用接口
 */
interface TokenService<T extends BasePointCommTotal, R extends BasePointCommRecord> {
...
//    default void saveRet(String bizId, GradeCode grade, PointCommOperationResult<T, R> operationResult,
